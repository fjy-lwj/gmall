...
public class SkuController {
    ...
    public ResponseVo<List<SkuEntity>> querySkusBySpuId(@PathVariable("spuId")Long pid) {
        List<SkuEntity> skuEntities = this.skuService.list(new QueryWrapper<SkuEntity>().eq("spu_id", pid));
