...
public class AttrGroupController {
    ...
    public ResponseVo<List<AttrGroupEntity>> queryGroupWithAttrsByCid(@PathVariable("catId")Long catId) {
        List<AttrGroupEntity> attrGroupEntities = this.attrGroupService.queryGroupWithAttrsByCid(catId);
